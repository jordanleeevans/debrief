...
class FakeCommand:
	"""Fake Discord command for testing"""
...
class FakeBot:
	...
	async def fetch_channel(self, channel_id):
		...
		fake_channel = object()  # Replace with actual channel object in real implementation
	...
	def add_command(self, name: str, callback):
		...
		self._commands[name] = FakeCommand(name, callback)
...
class FakeMessage:
	def __init__(
		self, id: int = 1, attachments: list | None = None, author: FakeAuthor | None = None
	):
		self.id = id
